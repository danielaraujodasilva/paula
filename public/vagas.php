...
$totalVagas = (int)$countStmt->fetchColumn();
...
<div class="d-flex align-items-center justify-content-between mb-3">
    ...
    <span class="text-muted small"><span data-jobs-loaded>0</span> de <span data-jobs-total><?= $totalVagas ?></span> vagas exibidas.</span>
</div>
<div class="table-responsive"><table class="table align-middle" data-jobs-table data-query="<?= e(http_build_query($_GET)) ?>">
...
<tr data-jobs-empty><td colspan="9" class="text-muted">Carregando vagas...</td></tr>
</tbody></table></div>
<div class="d-grid mt-3">
    <button class="btn btn-outline-light d-none" type="button" data-load-more-jobs>Carregar mais vagas</button>
    <div class="text-muted small text-center py-2 d-none" data-jobs-loading>Carregando mais vagas...</div>
    <div class="text-muted small text-center py-2 d-none" data-jobs-end>Fim dos resultados.</div>
</div>
<div data-jobs-sentinel></div>
</div></div>
